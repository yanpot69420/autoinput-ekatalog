...
PETUNJUK = [
    ...
    "",
    "Kolom Tipe Produk boleh dikosongkan; portal menentukannya dari kategori.",
    "",
    "FOTO, VIDEO, DAN DOKUMEN",
    "Semuanya diunggah sebagai BERKAS, bukan tautan. Isi dengan alamat berkas",
    "di komputer ini, contoh:",
    "  /Users/nama/Produk/galian-01.png",
    "Foto  : .jpg .jpeg .png, ukuran 300x300 sampai 2048x2048 px.",
    "        Setiap produk wajib punya minimal satu foto.",
    "Video : .mp4 atau .mov, maksimal 50 MB. Opsional.",
    "Dokumen: .pdf, maksimal 10 MB per berkas.",
    "Aplikasi memeriksa berkasnya benar-benar ada sebelum baris dijalankan.",
    "",
    "HARGA",
    ...
    "Kolom Berat, Panjang, Lebar, Tinggi, Atur Ongkir, PPnBM, dan Sertifikat",
    "TKDN hanya berlaku bila kategorinya bertipe Barang. Untuk Jasa dan",
    "Digital, kosongkan — bagian itu memang tidak muncul di form.",
    "Berat wajib diisi untuk produk Barang.",
    "",
    ...
    "",
    "LAMPIRAN DOKUMEN",
    "Cara yang sama: nama dokumen di 'Dokumen n', alamat berkas PDF di",
    "'Berkas n'. Contoh nama dokumen untuk pekerjaan konstruksi:",
    ...
    "",
    "YANG BELUM DIDUKUNG",
    "Varian, harga grosir, harga zonasi, layanan tambahan, serta rincian",
    "merek, SNI, dan TKDN. Saklarnya sudah ada, tapi isinya belum bisa",
    "dimasukkan lewat template — untuk sekarang diedit manual di portal.",
]
